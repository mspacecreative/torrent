...
?>
<div class="post-meta"><span class="show-author"><?php echo esc_html__('Posted on', 'stratus'); ?> <?php echo get_the_date(); ?><?php echo wp_kses_post( $link_the_date_close );?></time></span> <span class="is-sticky">| <?php echo esc_html__('Featured', 'stratus'); ?></span> <span class="show-comments"><?php echo wp_kses_post( $write_comments ); ?></span></div>
